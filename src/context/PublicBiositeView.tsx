                        ...
                        <div className="flex flex-wrap gap-0 w-full max-w-sm mx-auto">
                            {biositeData.appLinks.filter(link => link.isActive).map((appLink) => (
                                <a
                                    ...
                                    className={`flex-1 h-12  bg-white hover:bg-gray-800  transition-colors rounded-lg p-0 flex flex-col flex-wrap items-center space-x-3 border border-gray-600 ${
                                ...
                                >
                                    ...
                                    <div className="flex-shrink-0 gap-1">
                                            {appLink.store === 'appstore' ? (
                                                ...
                                                <svg width="30" height="30" viewBox="0 0 8 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className='flex flex-col items-center justify-start mt-1 -ml-8'>
                                        <div className={`${hasCustomUrls ? 'mt-1' : 'mt-0'} text-left`}>
