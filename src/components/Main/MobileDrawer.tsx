...
const SectionsWithDrawerInteraction: React.FC<SectionsWithDrawerInteractionProps> = ({ onSubsectionClick }) => {
    ...
    // Separate Profile section from draggable sections (like MySite.tsx)
    ...
    const mySiteSections = [
        {
            ...
            title: 'Perfil',
            icon: (
                <svg width="16" height="16" viewBox="0 0 50 51" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <div className="w-full">
            <div className="max-w-2xl mx-auto">
                ...
                {/* Add More Sections - Same as addMore.tsx */}
                <div className="mt-8">
