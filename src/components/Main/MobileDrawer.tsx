            ...
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="white">
                    <g fillRule="evenodd">
                        ...
                        <path stroke="white" strokeWidth="2" d="M15 2h7v7h-7V2ZM2 2h7v7H2V2Zm0 13h7v7H2v-7ZM18 5h1v1h-1V5ZM5 5h1v1H5V5Zm0 13h1v1H5v-1Z"/>
                    </g>
                </svg>
            ),
                        ...
                        <Droppable droppableId="mobile-sections" direction="vertical">
                            {(provided, snapshot) => (
                                <div
                                    ...
                                    className={`space-y-3 ${snapshot.isDraggingOver && isEditMode ? 'bg-blue-50/30 rounded-lg p-2' : ''}`}
                                >
                                            ...
                                            >
                                                {(provided, snapshot) => (
                                                    <div
                                                        ...
                                                        onClick={() => !isEditMode && !snapshot.isDragging && onSubsectionClick(section.titulo.toLowerCase().replace(/\s+/g, '').replace('linkdemiapp', 'app').replace('contactame', 'whatsapp').replace('socialpost', 'post').replace('music/podcast', 'music'))}
                                                        className={`
