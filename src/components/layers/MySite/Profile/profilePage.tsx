...
const ProfilePage = () => {
  ...
  const [slugValidationTimeout, setSlugValidationTimeout] = useState<number | null>(null);
  ...
  const validateSlugUnique = async (slug: string): Promise<boolean> => {
    ...
    try {
      ...
      const response = await apiService.getAll<any>(`/biosites?page=1&size=10&search=${encodeURIComponent(slug)}`);
          ...
          <div className="mb-6">
            ...
            <Form form={form} layout="vertical" onFinish={handleFinish}>
              ...
              <div className="mb-6">
                ...
                >
                  <Input
                      ...
                      suffix={slugValidating ? <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-blue-500"></div> : null}
                  />
                </Form.Item>
              ...
              <Form.Item className="mb-0">
                ...
                >
                  {loading || slugValidating ? 'Validando...' : 'Actualizar Perfil'}
                </Button>
              </Form.Item>
            </Form>
          </div>
