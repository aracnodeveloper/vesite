...
import { ChevronLeft, Loader2, CheckCircle, AlertCircle, Plus, Edit2, Trash2, Eye, Phone, MessageCircle } from "lucide-react";
...
const WhatsAppPage = () => {
    ...
    const hasChanges = () => {
        if (!editingLink) {
            return phone.trim() !== "" || message.trim() !== "" || description.trim() !== "";
        }
            ...
            <div className="px-6 py-4 border-b border-gray-700 sr-only sm:not-sr-only">
                <div className="flex items-center gap-3">
                    <button onClick={handleBackClick} className="flex items-center cursor-pointer text-gray-800 hover:text-white transition-colors">
                        ...
                        <h1 className="text-md font-bold text-gray-800  uppercase tracking-wide text-start hover:text-white">Enlaces de WhatsApp</h1>
                    </button>
                </div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center px-6 py-6 space-y-6 w-full">
                ...
                {!showForm && (
                    <div className="text-center space-y-4">
                        ...
                        <h2 className="font-bold text-black text-xl">Enlaces de WhatsApp</h2>
                        <p className="text-gray-600 text-sm">
                            Crea múltiples enlaces de WhatsApp con diferentes propósitos y mensajes personalizados.
                        </p>
                    </div>
                )}
                ...
                {!showForm && activeApiLinks && activeApiLinks.length > 0 && (
                    <div className="w-full max-w-md space-y-4">
                        <div className="flex items-center justify-between">
                            <h3 className="text-lg font-semibold text-gray-800">Enlaces activos</h3>
                        ...
                        <div className="space-y-3">
                            {activeApiLinks.map((link) => (
                                <div key={link.id} className="group bg-white border border-gray-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-all duration-200 hover:border-green-300">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="w-8 h-8 bg-gradient-to-br from-green-400 to-green-600 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg">
                                            <WhatsAppOutlined style={{ fontSize: '15px', color: 'white' }} />
                                        </div>
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-start justify-between">
                                                ...
                                                <div className="flex items-center gap-1 ml-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                    ...
                                                    <button
                                                        onClick={() => handleDelete(link.id, link.description || 'WhatsApp')}
                ...
                {!showForm && activeApiLinks.length === 0 && (
                    <div className="w-full max-w-md text-center py-8">
                        <div className="w-16 h-16 mx-auto bg-gray-100 rounded-full flex items-center justify-center mb-4">
                            <WhatsAppOutlined style={{ fontSize: '32px', color: '#9CA3AF' }} />
                        </div>
                        <h3 className="text-lg font-medium text-gray-900 mb-2">No hay enlaces activos</h3>
                    ...
                    <div className="w-full max-w-md">
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            ...
                            <ul className="text-xs text-blue-700 space-y-1">
                                ...
                                <li>• Solo se muestran enlaces activos de la API de WhatsApp</li>
                                <li>• Los botones aparecen en tu biosite cuando están activos</li>
