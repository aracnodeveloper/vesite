...
import type {BiositeFull,LinkData,LinkImageDisplayProps, TimeRange} from '../../../interfaces/AdminData.ts'
...
interface AdminChildBiositesTableProps {
...
export const AdminChildBiositesTable: React.FC<AdminChildBiositesTableProps> = ({
                                                                                    biosites,
                                                                                    totalBiosites,
                                                                                    loading,
                                                                                    biositeLinks,
    ...
    if (!biosites || biosites.length === 0) {
        return (
            <div className="text-center py-8">
                ...
                <p className="text-sm text-gray-400 mt-1">Los biosites hijos aparecerán aquí cuando se creen</p>
            </div>
        );
    }
            ...
            <div className="mb-4">
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <div className="flex items-center">
                        ...
                        <div>
                            <h3 className="text-sm font-medium text-yellow-800">Vista de Administrador</h3>
                            <p className="text-sm text-yellow-700">
                                Mostrando únicamente los biosites hijos bajo tu administración ({totalBiosites} biosites)
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    {biosites.map((biosite: BiositeFull) => {
                        ...
                        return (
                            <React.Fragment key={biosite.id}>
                                            ...
                                            <div className="space-y-4">
                                                <div className="flex items-center justify-between">
                                                    <h4 className="text-sm font-semibold text-blue-800 flex items-center">
                                                        ...
                                                        Analytics del Biosite Hijo ({analyticsTimeRange === 'last7' ? 'Últimos 7 días' : analyticsTimeRange === 'last30' ? 'Últimos 30 días' : 'Último año'})
                                                    </h4>
                                ...
                                {isExpanded && (
                                    <tr>
                                        <td colSpan={8} className="px-6 py-4 bg-gray-50 border-2 border-t-green-600 border-b-green-400">
                                                                                        ...
                                                                                        <div className="flex items-start space-x-3 flex-1">
                                                                                            ...
                                                                                            <div className="flex-1 min-w-0">
                                                                                                <div className="flex items-center space-x-2 mb-1">
                                                                                                    ...
                                                                                                    <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${linkType.color}`}>
                                                                                                        {linkType.icon}
