...
const SearchAndFilters: React.FC<SearchAndFiltersProps> = ({
    ...
    const getActiveFiltersCount = () => {
        ...
        if (filters.sortBy !== 'newest' || filters.sortOrder !== 'desc') count++;
        return count;
    };
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) => updateFilter('hasSlug', e.target.value as FilterState['hasSlug'])}
                                className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 cursor-pointer"
                                style={{ color: 'black' }}
                            >
                            ...
                            <div className="flex flex-wrap gap-2">
                                ...
                                {filters.hasSlug !== 'all' && (
                                    <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                                        Slug: {filters.hasSlug === 'with-slug' ? 'Con slug' : 'Sin slug'}
                                        <button
                                ...
                                {filters.dateRange !== 'all' && (
                                    <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                                        Fecha: {
                                        filters.dateRange === 'last7' ? 'Últimos 7 días' :
